...
public class One2OnePresenter extends MvpBasePresenter<One2OneView>
    ...
    public static final String STREAM_HOST = "wss://greenoxeco.in/one2one";
    ...
    public void connectServer() {
        ...
        socketService.connect(One2OnePresenter.STREAM_HOST, new BaseSocketCallback() {
            ...
            public void onClose(int i, String s, boolean b) {
                super.onClose(i, s, b);
                RxScheduler.runOnUi(o -> {
                    getView().logAndToast("Closed:"+i+":"+s+":"+b);
            ...
            public void onError(Exception e) {
                super.onError(e);
                RxScheduler.runOnUi(o -> {
                    getView().logAndToast("Exception in connection: "+e.toString());
                    getView().socketConnect(false);
                    disconnect();
                });
            }
